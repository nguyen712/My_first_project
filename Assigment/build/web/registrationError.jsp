...
<html>
    ...
    <body>
        ...
        <form action="DispatchServlet" method="POST">
            ...
            Username* <input type="email" name="txtUsername" value="${param.txtUsername}" />(e.g. 6 - 20 chars) <br/>
            ...
            Address* <input type="text" name="txtAddress" value="${param.txtAddress}" />(e.g. 2 - 50 chars)<br/>
